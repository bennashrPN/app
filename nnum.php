                    ...
                    <div class="col-xl-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="no" class="form-label ps-3">No Hp</label>
                                    <label for="no" class="col-sm-1 col-form-label">:</label>
                                    <input type="number" name="no_hp" 
                                    class="form-control" value="<?= $data['no_hp']?>" required  >
                                </div>
                                <div class="mb-3">
                                    ...
                                    <?php 
                                    $jabatan = ['Admin', 'Wali Kelas', 'Guru', 'Staf'];
                                    foreach ($jabatan as $jbtn) {
                                        if ($data ['jabatan']== $jbtn) {
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php 
                                    $role = ['Admin', 'Wali Kelas', 'Guru', 'Staf'];
                                    foreach ($role as $rol) {
                                        if ($data ['role']== $rol) {
