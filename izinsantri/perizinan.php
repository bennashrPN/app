        ...
        <div class="container-fluid px-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?= $main_url ?>izinsantri/add-perizinan.php" class="btn btn-sm btn-success float-end"> <i class="fa-solid fa-circle-plus"></i> Add </a>
                </div>
                <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', "#btnDelete", function() {
                ...
                let id = $(this).data('id');
                $("#btnmodalDelete").attr('href', '<?= $main_url ?>izinsantri/delete-perizinan.php?id=' + id);
            })
        });
    </script>
    <?php
