...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-5">Update Ustadz</h1>
            ...
            <form action="proses-ustadz.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card mb-4">
                            <div class="card-header">
                                <span class="h5 my-2"><i class="fa-solid fa-pen-to-square"></i> Edit Ustadz</span>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nip" pattern="[0-9]{10,}" title="NIP harus terdiri dari 10 angka" class="form-control" value="<?= $data['nip'] ?>" required>
                                </div>
                                <div class="mb-3">
                    ...
                    <div class="col-xl-6">
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fa-solid fa-square-plus"></i> Edit Foto
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    <!-- kode input foto -->
